...
const duration = 20; // 5 minutes in seconds
...
const dashoffset = circumference - (progress / 100) * circumference;
  ...
  return (
    <div>         <svg style={{ transform: 'rotate(-90deg)' }} height="100" width="100">
    <circle
      cx="50"
      cy="50"
      r={radius}
...
<stop offset="0%" style={{ stopColor: '#1D174F', stopOpacity: 1 }} />
<stop offset="100%" style={{ stopColor: '#1D174F', stopOpacity: 1 }} />
</linearGradient>
