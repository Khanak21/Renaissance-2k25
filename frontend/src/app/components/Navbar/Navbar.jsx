...
function Navbar() {
  ...
  return (
    ...
    // navbar component
    <nav
      className={`w-full text-white  flex flex-row justify-between z-[1000] fixed transition duration-600 ${navScroll ? "shadow-xl bg-bubble" : ""
        }`}
    >
      {/* logo  */}
      <div
      ...
      <div className="container justify-end hidden px-3 md:flex xl:px-12">
        <ul className="flex flex-row items-center justify-center text-sm font-light text-custom-nav">
          ...
          <Link
            ...
            className="mx-4 px-6 py-4 bg-[#EEF5DB]  text-custom-dark text-sm font-semibold shadow-[inset_0_0_0_0_rgb(238 245 219)] hover:text-white hover:shadow-[inset_15em_0_0_0_black] transition ease-in-out delay-50 duration-300"
          >
